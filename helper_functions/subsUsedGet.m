...
% Not all subjects in this data set have full functional coverage (esp in
% frontal regions)
% Out of 218 subjets, we chose 153 subjects with the best functional
% coverage and least amount of missed data (NaN's). 
% We then randomly drew either 150 (see below) or 20 subjects from this
% sample. 
subsUse = [];
switch fold 
    case 150
